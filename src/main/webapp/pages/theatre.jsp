      ...
      <div class="container-fluid">
        <div>
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<c:url value="/pages/theatre.jsp"/>" id="theatreTable">Theatre</a></li>
...
<script type="text/template" id="theatreFormTemplate"><jsp:include page="/javascripts/templates/theatreFormTemplate.js"/></script>
...
<script src="<c:url value="/javascripts/custom/admin/theatre.js"/>"></script>
</body>
</html>
