...
<div id="plot">
        ...
        <div>
          <ul class="nav navbar-nav">
            ...
            <%--<li><a href="<c:url value="/pages/ticket.jsp" />" id="ticket">Ticket</a></li>--%>
              <li class="active"><a href="<c:url value="/pages/editor.jsp"/>" id="editor">Редактор</a></li>
  ...
  <div class="formContainer">
    ...
    <div id="dbSchema"><img src="<c:url value="/images/DBSchmaEnglish.png"/>"/></div>
  </div>
</div>
...
<script src="<c:url value="/javascripts/custom/admin/editor.js"/>"></script>
</body>
</html>
