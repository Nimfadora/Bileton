      ...
      <div class="container-fluid">
        <div>
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<c:url value="/pages/troupes.jsp"/>" id="troupeTable">Troupe</a></li>
...
<script type="text/template" id="troupeFormTemplate"><jsp:include page="/javascripts/templates/troupeFormTemplate.js"/></script>
...
<script src="<c:url value="/javascripts/custom/admin/troupe.js"/>"></script>
</body>
</html>
