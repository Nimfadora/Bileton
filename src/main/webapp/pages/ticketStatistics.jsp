      ...
      <div class="container-fluid">
        <div>
          <ul class="nav navbar-nav">
            ...
            <li  class="active"><a href="<c:url value="/pages/ticketStatistics.jsp"/>" id="ticketSt">Ticket Statistics</a></li>
          </ul>
        </div>
      </div>
    </nav>
...
<script src="<c:url value="/javascripts/custom/admin/ticketStatistics.js"/>"></script>
</body>
</html>
