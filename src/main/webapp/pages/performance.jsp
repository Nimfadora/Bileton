        ...
        <div>
          <ul class="nav navbar-nav">
            <%--<li><a href="<c:url value="/pages/admin.jsp"/>" id="home">Home</a></li>--%>
              ...
              <li class="active"><a href="<c:url value="/pages/performance.jsp" />" id="perftable">Представление</a></li>
...
<script type="text/template" id="perfFormTemplate"><jsp:include page="/javascripts/templates/perfFormTemplate.js"/></script>
...
<script src="<c:url value="/javascripts/custom/admin/performance.js"/>"></script>
</body>
</html>