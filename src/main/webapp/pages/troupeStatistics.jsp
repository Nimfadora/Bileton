        ...
        <div>
          <ul class="nav navbar-nav">
            <%--<li><a href="<c:url value="/pages/admin.jsp"/>" id="home">Home</a></li>--%>
              ...
              <li class="active"><a href="<c:url value="/pages/troupeStatistics.jsp"/>" id="troupeSt">Труппы: статистика</a></li>
...
<script src="<c:url value="/javascripts/custom/admin/troupeStatistics.js"/>"></script>
</body>
</html>
