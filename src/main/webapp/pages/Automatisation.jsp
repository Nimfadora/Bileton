      ...
      <div class="container-fluid">
        <div>
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<c:url value="/pages/Automatisation.jsp"/>" id="automatisation">Automatisation</a></li>
          </ul>
        </div>
      </div>
    </nav>
...
<script type="text/template" id="automatisationFormTemplate"><jsp:include page="/javascripts/templates/automatisationFormTemplate.js"/></script>
...
<script src="<c:url value="/javascripts/custom/admin/automatisation.js"/>"></script>
</body>
</html>
