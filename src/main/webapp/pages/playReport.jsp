...
<div id="plot">
      ...
      <div class="container-fluid">
        <div>
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<c:url value="/pages/playReport.jsp" />" id="playReport">Постановки: отчёт</a></li>
  ...
  <div class="formContainer">
    <button class="btn btn-default print">Печать</button>
...
<script src="<c:url value="/javascripts/custom/admin/playReport.js"/>"></script>
</body>
</html>
